...
typedef enum
{
    ...
    CAMERA_ATTR_EFFECT_OTHER_GRAPHICS,       /**<Other Graphics effect */
...
/**
 * @brief	Enumerations of the camera light state.
 */
typedef enum
{
    CAMERA_LIGHT_STATE_NORMAL = 0,	/**< Light normal.*/
    CAMERA_LIGHT_STATE_LOW,			/**< Low light*/
} camera_light_state_e;
...
/**
 * @brief	Enumerations of the shutter sound.
 */
typedef enum
{
    CAMERA_SHUTTER_SOUND_DEFAULT = 0,  /**< Default shutter sound */
    CAMERA_SHUTTER_SOUND_EXT_01,       /**< Extra shutter sound 1 */
    CAMERA_SHUTTER_SOUND_EXT_02,       /**< Extra shutter sound 2 */
} camera_shutter_sound_e;
...
/**
 * @brief	Called when the camera light state changes.
 * @details When the camera detect low light,the light state change occurs,
 * this callback is invoked. \n \n
 * Changes of light state are as follows: \n
 * #CAMERA_LIGHT_STATE_NORMAL or #CAMERA_LIGHT_STATE_LOW
 *
 * @param[in] state         The current state of the camera light
 * @param[in] user_data     The user data passed from the callback registration function
 * @see	camera_set_low_light_state_changed_cb()
 * @see	camera_unset_low_light_state_changed_cb()
 */
typedef void (*camera_low_light_state_changed_cb)(camera_light_state_e state, void *user_data);


/**
 * @brief	Called when the camera shutter sound is played.
 * @details When the camera shutter sound is played, this callback is invoked. \n
 * and this callback is available when only single capture mode, not support continuous capture. \n \n
 *
 * @param[in] user_data     The user data passed from the callback registration function
 * @see	camera_set_shutter_sound_cb()
 * @see	camera_unset_shutter_sound_cb()
 */
typedef void (*camera_shutter_sound_cb)(void *user_data);


/**
 * @brief	Called when the camera shutter sound playing is completed.
 * @details When the camera shutter sound playing is completed, this callback is invoked. \n
 * and this callback is available when only single capture mode, not support continuous capture. \n \n
 *
 * @param[in] user_data     The user data passed from the callback registration function
 * @see	camera_set_shutter_sound_completed_cb()
 * @see	camera_unset_shutter_sound_completed_cb()
 */
typedef void (*camera_shutter_sound_completed_cb)(void *user_data);
 ...
 *
 * @remarks If current display type is not #CAMERA_DISPLAY_TYPE_X11, no operation is performed.
 * @param[in]   user_data  The user data passed from the callback registration function
 *
 * @return	The updated xid
 * @pre It will be invoked when camera needs updated xid if you register this callback using camera_set_x11_display_pixmap()
 *
...
/**
 * @brief Called when the media camera needs to inform rendering error
 *
 * @remarks If current display type is not #CAMERA_DISPLAY_TYPE_X11, no operation is performed.
...
/**
 * @brief Registers a callback function to be invoked when camera need updated xid.
 * @ingroup CAPI_MEDIA_CAMERA_X11_DISPLAY_MODULE
 *
 * @remarks  This function is valid only for #CAMERA_DISPLAY_TYPE_X11.
 * @param[in] camera	The handle to the camera
...
/**
 * @brief Registers a callback function to be invoked when failure of rendering preview frame happen.
 * @ingroup CAPI_MEDIA_CAMERA_X11_DISPLAY_MODULE
 *
 * @remarks  This function is valid only for #CAMERA_DISPLAY_TYPE_X11.
 * @param[in] camera	The handle to the camera
...
/**
 * @brief	Registers a callback function to be called when low light state changes.
 *
 * @param[in] camera	The handle to the camera
 * @param[in] callback	The callback function to register
 * @param[in] user_data	The user data to be passed to the callback function
 ...
 * @retval    #CAMERA_ERROR_NONE Successful
 * @retval    #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 * @post	This function will invoke camera_low_light_state_changed_cb() when ligth state changes.
 *
 * @see	camera_unset_low_light_state_changed_cb()
 * @see	camera_low_light_state_changed_cb()
 */
int camera_set_low_light_state_changed_cb(camera_h camera, camera_low_light_state_changed_cb callback, void* user_data);

/**
 * @brief	Unregisters callback function about the low ligth state changed.
 *
 * @param[in]	camera	The handle to the camera
 * @return	  0 on success, otherwise a negative error value.
 * @retval    #CAMERA_ERROR_NONE Successful
 ...
 * @see     camera_set_low_light_state_changed_cb()
 */
int camera_unset_low_light_state_changed_cb(camera_h camera);

/**
 * @brief	Registers a callback function to be called when shutter sound is played.
 *
 * @param[in] camera	The handle to the camera
 * @param[in] callback	The callback function to register
 * @param[in] user_data	The user data to be passed to the callback function
 ...
 * @retval    #CAMERA_ERROR_NONE Successful
 * @retval    #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 * @post	This function will invoke camera_shutter_sound_cb() when shutter sound is played.
 *
 * @see	camera_unset_shutter_sound_cb()
 * @see	camera_shutter_sound_cb()
 */
int camera_set_shutter_sound_cb(camera_h camera, camera_shutter_sound_cb callback, void* user_data);

/**
 * @brief	Unregisters callback function about the shutter sound played.
 *
 * @param[in]	camera	The handle to the camera
 * @return	  0 on success, otherwise a negative error value.
 * @retval    #CAMERA_ERROR_NONE Successful
 ...
 * @see     camera_set_shutter_sound_cb()
 */
int camera_unset_shutter_sound_cb(camera_h camera);

/**
 * @brief	Registers a callback function to be called when shutter sound playing is completed.
 *
 * @param[in] camera	The handle to the camera
 * @param[in] callback	The callback function to register
 * @param[in] user_data	The user data to be passed to the callback function
 ...
 * @retval    #CAMERA_ERROR_NONE Successful
 * @retval    #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 * @post	This function will invoke camera_shutter_sound_completed_cb() when shutter sound playing is completed.
 *
 * @see	camera_unset_shutter_sound_completed_cb()
 * @see	camera_shutter_sound_completed_cb()
 */
int camera_set_shutter_sound_completed_cb(camera_h camera, camera_shutter_sound_completed_cb callback, void* user_data);

/**
 * @brief	Unregisters callback function about the shutter sound completed.
 *
 * @param[in]	camera	The handle to the camera
 * @return	  0 on success, otherwise a negative error value.
 * @retval    #CAMERA_ERROR_NONE Successful
 ...
 * @see     camera_set_shutter_sound_completed_cb()
 */
int camera_unset_shutter_sound_completed_cb(camera_h camera);
...
/**
 * @brief Sets the lock of auto exposure.
 *
 * @param[in]	camera	The handle to the camera
 * @param[in]	lock The lock of auto exposure
 * @return	  0 on success, otherwise a negative error value.
 * @retval      #CAMERA_ERROR_NONE Successful
 * @retval      #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 *
 * @see camera_attr_get_auto_exposure_lock()
 */
int camera_attr_set_auto_exposure_lock(camera_h camera, bool lock);

/**
 * @brief Gets the lock of auto exposure.
 *
 * @param[in]	camera	The handle to the camera
 * @param[out]	lock The lock of auto exposure
 * @return	  0 on success, otherwise a negative error value.
 * @retval      #CAMERA_ERROR_NONE Successful
 * @retval      #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 *
 * @see camera_attr_set_auto_exposure_lock()
 */
int camera_attr_get_auto_exposure_lock(camera_h camera, bool *lock);

/**
 * @brief Sets the lock of auto white balance.
 *
 * @param[in]	camera	The handle to the camera
 * @param[in]	lock The lock of auto white balance
 * @return	  0 on success, otherwise a negative error value.
 * @retval      #CAMERA_ERROR_NONE Successful
 * @retval      #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 *
 * @see camera_attr_get_auto_white_balance_lock()
 */
int camera_attr_set_auto_white_balance_lock(camera_h camera, bool lock);

/**
 * @brief Gets the lock of auto white balance.
 *
 * @param[in]	camera	The handle to the camera
 * @param[out]	lock The lock of auto white balance
 * @return	  0 on success, otherwise a negative error value.
 * @retval      #CAMERA_ERROR_NONE Successful
 * @retval      #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 *
 * @see camera_attr_set_auto_white_balance_lock()
 */
int camera_attr_get_auto_white_balance_lock(camera_h camera, bool *lock);
...
/**
 * @brief Set shutter sound.
 *
 * @param[in] camera The handle to the camera
 * @param[in] sound The shutter sound to play when capture
 * @return	    0 on success, otherwise a negative error value.
 * @retval      #CAMERA_ERROR_NONE Successful
 * @retval      #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 */
int camera_attr_set_shutter_sound(camera_h camera, camera_shutter_sound_e sound);

/**
 * @brief Get shutter sound.
 *
 * @param[in] camera The handle to the camera
 * @param[out] sound The shutter sound to play when capture
 * @return	    0 on success, otherwise a negative error value.
 * @retval      #CAMERA_ERROR_NONE Successful
 * @retval      #CAMERA_ERROR_INVALID_PARAMETER Invalid parameter
 */
int camera_attr_get_shutter_sound(camera_h camera, camera_shutter_sound_e *sound);
